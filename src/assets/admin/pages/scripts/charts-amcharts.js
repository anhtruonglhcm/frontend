let ChartsAmcharts = function () {
    return {
        //main function to initiate the module
        init: function () {
            this.initChartSample1();
            this.initChartSample2();
            this.initChartSample3();
            this.initChartSample4();
            this.initChartSample5();
            this.initChartSample6();
            this.initChartSample7();
            this.initChartSample8();
            this.initChartSample9();
            this.initChartSample10();
            this.initChartSample11();
            this.initChartSample12();
        },
        initChartSample1: function () {
            let chart = AmCharts.makeChart("chart_1", {
                "type": "serial",
                "theme": "light",
        ...
        initChartSample2: function () {
            let chart = AmCharts.makeChart("chart_2", {
                "type": "serial",
                "theme": "light",
        ...
        initChartSample3: function () {
            let chart = AmCharts.makeChart("chart_3", {
                "type": "serial",
                "theme": "light",
        ...
        initChartSample4: function () {
            let chart = AmCharts.makeChart("chart_4", {
                "type": "serial",
                "theme": "light",
        ...
        initChartSample5: function () {
            let chart = AmCharts.makeChart("chart_5", {
                "theme": "light",
                "type": "serial",
                "startDuration": 2,
        ...
        initChartSample6: function () {
            let chart = AmCharts.makeChart("chart_6", {
                "type": "pie",
                "theme": "light",
        ...
        initChartSample7: function () {
            let chart = AmCharts.makeChart("chart_7", {
                "type": "pie",
                "theme": "light",
        ...
        initChartSample8: function () {
            let chart = AmCharts.makeChart("chart_8", {
                "type": "radar",
                "theme": "light",
        ...
        initChartSample9: function () {
            let chart = AmCharts.makeChart("chart_9", {
                "type": "radar",
                "theme": "light",
        ...
        */
            ...
            AmCharts.ready(function () {
                ...
                for (let i = 0; i < mapData.length; i++) {
                    ...
                    let size = (value - min) / (max - min) * (maxBulletSize - minBulletSize) + minBulletSize;
        ...
        initChartSample11: function () {
            ...
            let map = AmCharts.makeChart("chart_11", {
                type: "map",
                "theme": "light",
        ...
        initChartSample12: function () {
            ...
            let chart = AmCharts.makeChart("chart_12", {
                type: "stock",
                "theme": "light",
                pathToImages: Metronic.getGlobalPluginsPath() + "amcharts/amcharts/images/",
                "fontFamily": 'Open Sans',
        ...
        initChartSample13: function ($el, colors_step) {
            let chart = am4core.create($el, am4charts.XYChart)
            chart.colors.step = (typeof colors_step !== undefined ? colors_step : 2);
            ...
            chart.createSeries = function(value, name) {
                let series = this.series.push(new am4charts.ColumnSeries())
