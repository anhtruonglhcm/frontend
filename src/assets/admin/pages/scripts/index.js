var Index = function () {
    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range, .dashboard-report-range').daterangepicker({
            ...
            $('#dashboard-report-range span, .dashboard-report-range span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
            $('#dashboard-report-range, .dashboard-report-range').show();
        }
